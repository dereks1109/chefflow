...
export function buildDemoRecipes(now: number): DemoRecipe[] {
  return [
    buildRecipe({
      ...
      pricePerPortion: 15,
      analysis: { caloriesPerPortion: 880, caloriesTotal: 1760, keyIngredientTags: ['beef', 'butter', 'garlic'], allergens: ['milk'] },
      now,
    }),
    buildRecipe({
      ...
      pricePerPortion: 2.5,
      analysis: { caloriesPerPortion: 90, caloriesTotal: 360, keyIngredientTags: ['lettuce', 'tomato', 'cucumber'], allergens: [] },
      now,
    }),
    buildRecipe({
      ...
      pricePerPortion: 2,
      analysis: { caloriesPerPortion: 200, caloriesTotal: 800, keyIngredientTags: ['tomato', 'basil', 'cream'], allergens: ['milk'] },
      now,
    }),
    buildRecipe({
      ...
      pricePerPortion: 2,
      analysis: { caloriesPerPortion: 220, caloriesTotal: 880, keyIngredientTags: ['black pepper', 'cream', 'shallot'], allergens: ['milk'] },
      now,
    }),
    buildRecipe({
      ...
      pricePerPortion: 3,
      analysis: { caloriesPerPortion: 140, caloriesTotal: 560, keyIngredientTags: ['cucumber', 'yogurt', 'dill'], allergens: ['milk'] },
    ...
    buildRecipe({
      ...
      pricePerPortion: 8,
      analysis: { caloriesPerPortion: 280, caloriesTotal: 1120, keyIngredientTags: ['scallops', 'butter', 'lemon'], allergens: ['molluscs', 'milk'] },
    ...
    buildRecipe({
      ...
      pricePerPortion: 2.5,
      analysis: { caloriesPerPortion: 220, caloriesTotal: 880, keyIngredientTags: ['cabbage', 'mushroom', 'ginger'], allergens: ['gluten', 'soybeans', 'sesame'] },
    ...
    buildRecipe({
      ...
      pricePerPortion: 7,
      analysis: { caloriesPerPortion: 210, caloriesTotal: 840, keyIngredientTags: ['tuna', 'avocado', 'sriracha'], allergens: ['fish', 'soybeans', 'sesame'] },
    ...
    buildRecipe({
      ...
      pricePerPortion: 5,
      analysis: { caloriesPerPortion: 320, caloriesTotal: 1280, keyIngredientTags: ['calamari', 'lemon', 'paprika'], allergens: ['gluten', 'molluscs'] },
    ...
    buildRecipe({
      ...
      pricePerPortion: 12,
      analysis: { caloriesPerPortion: 520, caloriesTotal: 2080, keyIngredientTags: ['lamb', 'rosemary', 'mustard'], allergens: ['gluten', 'mustard'] },
    ...
    buildRecipe({
      ...
      pricePerPortion: 11,
      analysis: { caloriesPerPortion: 380, caloriesTotal: 1520, keyIngredientTags: ['swordfish', 'capers', 'parsley'], allergens: ['fish', 'sulphites'] },
    ...
    buildRecipe({
      ...
      pricePerPortion: 9,
      analysis: { caloriesPerPortion: 580, caloriesTotal: 3480, keyIngredientTags: ['pork belly', 'soy', 'star anise'], allergens: ['soybeans', 'sulphites'] },
    ...
    buildRecipe({
      ...
      pricePerPortion: 6,
      analysis: { caloriesPerPortion: 620, caloriesTotal: 2480, keyIngredientTags: ['chicken', 'tikka', 'masala'], allergens: ['milk'] },
    ...
    buildRecipe({
      ...
      pricePerPortion: 3,
      analysis: { caloriesPerPortion: 410, caloriesTotal: 2460, keyIngredientTags: ['cream', 'vanilla', 'custard'], allergens: ['milk', 'eggs'] },
    ...
    buildRecipe({
      id: 'r_demo_mango_sorbet', title: '(Demo) Mango Sorbet', originalYield: 6,
      prepTime: '15m', cookTime: '5m',
      ingredients: [
        { amount: 500, unit: 'g', name: 'Ripe mango (puree)' },
        { amount: 100, unit: 'g', name: 'Caster sugar' },
        { amount: 100, unit: 'ml', name: 'Water' },
        { amount: 1, unit: 'whole', name: 'Lime' },
      ],
      steps: [
        { text: 'Simmer sugar and water in a small pan 3 minutes to make a syrup; cool fully.', phase: 'prep' },
        { text: 'Blend mango puree with the cooled syrup and lime juice until smooth.', phase: 'prep' },
        { text: 'Churn in an ice cream maker 25 minutes, OR pour into a tray and fork through every 30 minutes for 3 hours.' },
        { text: 'Scoop into chilled bowls. Best within 48 hours.', phase: 'serve' },
      ],
      pricePerPortion: 2,
      analysis: { caloriesPerPortion: 180, caloriesTotal: 1080, keyIngredientTags: ['mango', 'lime', 'sorbet'], allergens: [] },
      description: '🥭 Bright tropical mango sorbet sharpened with 🍋 lime — fully dairy-free, deeply refreshing. The dessert that disappears first.',
      now,
    }),
  ];
}
